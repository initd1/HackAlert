                ...
                with open('all_breaches.json', 'r')  as f:
                    ...
                    for breach in breaches:
                        if 'Name' in breach and breach['Name'] == search_name:
                            ...
                            if 'Name' in breach:
                                logger.debug(colored("Breach name:", "blue"), colored(breach_name['Name'], "red"))
                            if 'Description' in breach:
                                logger.debug(colored("Breach description:", "blue"), colored(breach['Description'], "red"))
                            if 'BreachDate' in breach:
                                logger.debug(colored("Breach date:", "blue"), colored(breach['BreachDate'], "white"))
                            if 'DataClasses' in breach:
                                logger.debug(colored("Data classes that were part of this breach:", "blue"), colored(breach['DataClasses'], "red"))
                            if 'IsSensitive' in breach and breach['IsSensitive'] == True:
                                logger.debug(colored("Breach is sensitive:", "blue"), colored(breach['IsSensitive'], "yellow"))
                            if 'IsSensitive' in breach and breach['IsSensitive'] == False:
                                logger.debug(colored("Breach is sensitive:", "blue"), colored(breach['IsSensitive'], "green"))
                            if 'IsVerified' in breach and breach['IsVerified'] == True:
                                logger.debug(colored("Breach is verified:", "blue"), colored(breach['IsVerified'], "green"))
                            if 'IsVerified' in breach  and breach['IsVerified'] == False:
                                logger.debug(colored("Breach is verified:", "blue"), colored(breach['IsVerified'], "red"))
                            # print(colored("Number of accounts compromised:", "blue"), colored(breach['PwnCount'], "white"))
                            logger.debug(colored("Number of accounts compromised:", "blue"), colored('{:,}'.format(breach['PwnCount']), "white"))
                        else:
                            pass
        else:
